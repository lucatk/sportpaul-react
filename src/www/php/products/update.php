...
$db = new Database();
if(strlen($_POST["flockingPriceName"]) < 1 || $_POST["flockingPriceName"] == "null")
  $_POST["flockingPriceName"] = null;
if(strlen($_POST["flockingPriceLogo"]) < 1 || $_POST["flockingPriceLogo"] == "null")
  $_POST["flockingPriceLogo"] = null;
...
if(isset($_FILES["picture"])) {
  ...
  $stmt = $db->execute("UPDATE products SET displayorder=:displayorder, internalid=:internalid, name=:name, colours=:colours, pricegroups=:pricegroups, flockingPriceName=:flockingPriceName, flockingPriceLogo=:flockingPriceLogo, includedFlockingInfo=:includedFlockingInfo, picture=:picture WHERE id=:id AND clubid=:clubid", ["id" => $_POST["id"],
                                                                                                                                                                                                                                                                                                                                    "clubid" => $_POST["clubid"],
  ...
  if(isset($_FILES) && count($_FILES) > 0) {
    ...
    $stmt = $db->execute("UPDATE products SET displayorder=:displayorder, internalid=:internalid, name=:name, colours=:colours, pricegroups=:pricegroups, flockingPriceName=:flockingPriceName, flockingPriceLogo=:flockingPriceLogo, includedFlockingInfo=:includedFlockingInfo WHERE id=:id AND clubid=:clubid", ["id" => $_POST["id"],
                                                                                                                                                                                                                                                                                                                    "clubid" => $_POST["clubid"],
                                                                                                                                                                                                                                                                                                                    "displayorder" => $_POST["displayorder"],
                                                                                                                                                                                                                                                                                                                    "internalid" => $_POST["internalid"],
                                                                                                                                                                                                                                                                                                                    "name" => $_POST["name"],
