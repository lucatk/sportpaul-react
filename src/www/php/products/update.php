...
if(isset($_FILES["picture"])) {
  ...
  $stmt = $db->execute("UPDATE products SET internalid=:internalid, name=:name, pricegroups=:pricegroups, flockingPrice=:flockingPrice, picture=:picture WHERE id=:id AND clubid=:clubid", ["id" => $_POST["id"],
                                                                                                                                                                                            "clubid" => $_POST["clubid"],
  ...
  $stmt = $db->execute("UPDATE products SET internalid=:internalid, name=:name, pricegroups=:pricegroups, flockingPrice=:flockingPrice WHERE id=:id AND clubid=:clubid", ["id" => $_POST["id"],
                                                                                                                                                                          "clubid" => $_POST["clubid"],
                                                                                                                                                                          "internalid" => $_POST["internalid"],
                                                                                                                                                                          "name" => $_POST["name"],
                                                                                                                                                                          "pricegroups" => $_POST["pricegroups"],
