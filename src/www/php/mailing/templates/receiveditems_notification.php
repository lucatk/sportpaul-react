                              ...
                              <table class="item-list" border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;margin-bottom:15px;">
                                <?php foreach($items as $item) { ?>
                                  <tr>
                                    ...
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                      <?php echo $item->name ?> (Art. Nr. <?php echo $item->internalid ?>, Größe: <?php echo $item->size ?><?php echo (strlen($item->flocking) > 0 ? "; Beflockung: " . $item->flocking : "") ?>)</td>
                                          </tr>
                                          <?php } ?>
                                            <!-- <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                                  <tr>
                                    <td class="content-block" style="font-family:sans-serif;font-size:14px;vertical-align:top;color:#999999;font-size:12px;text-align:center;">
                                      <span style="color:#999999;font-size:12px;text-align:center;">Sport Paul GmbH, Friedrichstrasse 57, 72336 Balingen
                    <br>
                                         Telefon: +49743321442</span>
                                    </td>
                                  </tr>
                                </table>
                              </div>
